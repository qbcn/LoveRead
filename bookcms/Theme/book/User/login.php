...
<link rel="stylesheet" href="<?php echo C('APP_ASSETS_URL'); ?>/style.css" type="text/css" media="screen" />
...
<div class="container" id="login">
	<div class="text-center login-head">
		<a href="<?php echo mc_site_url(); ?>"><img src="<?php $site_logo=mc_option('logo');if($site_logo) echo $site_logo; else echo C('APP_ASSETS_URL').'/img/logo-s.png'; ?>"></a>
		<h1>一个帐号，玩转本站所有服务！</h1>
