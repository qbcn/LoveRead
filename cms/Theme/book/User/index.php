				...
				<div class="col-md-4 col-lg-3 hidden-xs hidden-sm home-side">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<a class="pull-right" href="<?php echo U('publish/index/add_post'); ?>"><i class="fa fa-plus"></i></a>
						</div>
						<?php 
							...
							<li class="list-group-item">
								<div class="media">
									<div class="media-left">
										<a class="img-div" href="<?php echo mc_get_url($author); ?>">
									...
									<div class="media-body">
										...
										<p>
											<?php echo mc_cut_str(strip_tags(mc_magic_out(mc_get_page_field($val['id'],'content'))), 14); ?>
										</p>
									</div>
								</div>
							</li>
