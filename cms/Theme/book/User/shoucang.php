	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12" id="post-list-default">
				...
				<ul class="nav nav-tabs nav-justified mb-20">
				...
				<ul class="list-group">
				<?php $pages_id=array(); foreach($page as $val) : $pages_id[]=$val['id']; ?>
				<li class="list-group-item" id="mc-page-<?php echo $val['id']; ?>">
					<div class="row">
						...
						<div class="col-sm-6 col-md-5 col-lg-3 text-right">
							<?php 
								if($type=='pro') :
								$type_name = '<span class="btn btn-sm btn-info">图书</span>';
								elseif($type=='group') :
								$type_name = '<span class="btn btn-sm btn-info">话题</span>';
								elseif($type=='article') :
		...
		<?php echo W("Media/play",array($pages_id)); ?>
	</div>
