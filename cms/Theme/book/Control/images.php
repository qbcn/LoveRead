<?php mc_template_part('header_admin'); ?>
	<div class="container-admin">
		...
		<div class="home-main" id="images">
			...
			<?php echo $count; echo mc_pagenavi($count,$page_now,20); ?>
		</div>
	</div>
