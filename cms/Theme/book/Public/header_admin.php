	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			...
			<ul class="nav nav-sidebar">
				...
				<li><a href="<?php echo U('control/index/wish'); ?>"><i class="fa fa-circle-o"></i> 心愿订单</a></li>
			...
			<ul class="nav nav-sidebar">
				<li><a href="<?php echo U('publish/index/add_group'); ?>"><i class="fa fa-circle-o"></i> 新建群组</a></li>
			...
			<ul class="nav nav-sidebar">
				...
				<li><a href="<?php echo U('custom/admin/add_article'); ?>"><i class="fa fa-circle-o"></i> 发布文章</a></li>
			</ul>
			<ul class="nav nav-sidebar">
